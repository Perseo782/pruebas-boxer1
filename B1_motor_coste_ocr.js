...
var _B1_MOTOR_TABLA_B_MARCAS_COMERCIALES = [
  'peso neto', 'peso liquido', 'peso líquido', 'contenido neto',
  'volumen neto', 'cantidad neta', 'net weight', 'net volume',
  'peso', 'liquido', 'líquido', 'neto', 'contenido'
];

var _B1_MOTOR_TABLA_B_MARCAS_NUTRICIONALES = [
  'informacion nutricional', 'información nutricional', 'declaracion nutricional',
  'declaração nutricional', 'valores nutricionales', 'valores nutricionales por',
  'valores medios por', 'valores médios por', 'valeurs nutritionnelles',
  'nutrition facts', 'nutrition', 'energy value', 'valor energetico',
  'valor energético', 'energia', 'grasas', 'lipidos', 'lípidos',
  'hidratos de carbono', 'carbohidratos', 'azucares', 'azúcares',
  'proteinas', 'proteínas', 'sal', 'saturadas', 'saturados',
